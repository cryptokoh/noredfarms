...
// Default is dark — only switch if user has explicitly chosen light
(function() {
...
function initNavigation() {
    ...
    // Inject theme toggle button into nav
    if (container) {
        var themeBtn = document.createElement('button');
        themeBtn.className = 'theme-toggle';
        themeBtn.setAttribute('aria-label', 'Toggle light/dark mode');
        themeBtn.id = 'themeToggle';
        // Insert before hamburger (so it appears next to it on mobile)
        if (hamburgerEl) {
            container.insertBefore(themeBtn, hamburgerEl);
        } else {
...
function initThemeToggle() {
    ...
    // SVG icons: filled bulb = light mode active, outline bulb = dark mode active
    var iconLight = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>';
    var iconDark = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>';
    ...
    function updateIcon() {
        btn.innerHTML = isLight() ? iconLight : iconDark;
    }

    function updateMetaThemeColor() {
        var meta = document.querySelector('meta[name="theme-color"]');
        if (meta) {
            meta.setAttribute('content', isLight() ? '#f4f6f5' : '#12181a');
        }
    }
